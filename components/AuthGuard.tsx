    ...
    return (
      <div className="min-h-screen bg-[#07080a] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <img src="/logo.png" alt="Turing" className="w-14 h-14 object-cover object-center" />
        ...
        <div className="min-h-screen bg-[#07080a] flex items-center justify-center">
          <div className="w-full max-w-sm space-y-6 p-8">
            <div className="text-center space-y-2">
              <img src="/logo.png" alt="Turing" className="w-16 h-16 mx-auto mb-3 object-cover object-center" />
